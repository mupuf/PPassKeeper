...
class ListPwd
{
	private:
		...
		unsigned int updateDataBase(KWallet::Wallet* wallet, const char* prefix, ppk_password_type type);
	...
	public:
		unsigned int getPasswordListCount(KWallet::Wallet* wallet, const char* prefix, ppk_password_type type);
		unsigned int getPasswordList(KWallet::Wallet* wallet, const char* prefix, ppk_password_type type, void* pwdList, unsigned int maxPasswordCount);
};
